...
class ResNetGeneral(BaseModel):
    def __init__(
        ...
        mode,
        training,
        checkpoint='/data/meng/meng/OOD/resnet152/ckpts/model_90.pth',
        transforms=[],
        device='cuda:0',
        **kwargs
    ):
    ...
    def build(self):
        ...
        model = torchvision.models.__dict__[self.backbone](pretrained=False)
    ...
    def _train(self, sample):
        ...
        self.optim.step()
        # print("111111111")
        # print("resnet oss_trackers['loss']")
        # print(self.loss_trackers['loss'])#[3.8025636672973633, 3.5187339782714844, 2.888455629348755]
        # print(loss)#tensor(3.5187, device='cuda:0', grad_fn=<NllLossBackward>)
        # print("56565656565")
