...
def train(cfg):
    ...
    val_dataset = construct_class_by_name(**cfg.dataset, data_type='test', category='all')
    ...
    model = construct_class_by_name(
        **cfg.model, cfg=cfg.model, cate='all', mode='test',checkpoint='/data/meng/meng/OOD/resnet152/ckpts/model_90.pth')
